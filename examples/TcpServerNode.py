...
class Node(threading.Thread):
    ...
    def send_visuals(self, type, data):
        if ( self.visuals ):
            ...
            self.udp_server.sendto(message.encode('utf-8'), ('dev.codingskills.nl', 15000))
            
            self.udp_server.sendto(message.encode('utf-8'), ('codingskills.nl', 15000))
